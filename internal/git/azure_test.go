...
func TestAzureDevOpsProvider_Clone_Options(t *testing.T) {
	provider := NewAzureDevOpsProviderWithToken("test_token", "myorg", "myproject")
...
func TestAzureDevOpsProvider_Push_Options(t *testing.T) {
	provider := NewAzureDevOpsProviderWithToken("test_token", "myorg", "myproject")
...
func TestAzureDevOpsProvider_Pull_Options(t *testing.T) {
	provider := NewAzureDevOpsProviderWithToken("test_token", "myorg", "myproject")
...
func TestAzureDevOpsProvider_TestConnection_Behavior(t *testing.T) {
	provider := NewAzureDevOpsProviderWithToken("test_token", "myorg", "myproject")
